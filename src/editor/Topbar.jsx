                ...
                <GroupedDropdown
                    ...
                    renderTrigger={({ selected }) => {
                        ...
                        return (
                            <button
                                type="button"
                                className="topbar-device-selector"
                            > 
